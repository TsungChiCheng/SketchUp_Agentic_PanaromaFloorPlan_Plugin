# SketchUp Agentic Panorama FloorPlan Plugin
...
SketchUp Agentic Panorama FloorPlan Plugin is a SketchUp extension backed by local FastAPI services for agentic architectural rendering. From the SketchUp dialog, a user can ask for a render, edit the latest generated image, discuss a design direction, or generate a color point-cloud artifact from a PNG.
...
![SketchUp Agentic Panorama FloorPlan Plugin dialog](docs/current-extension-ui.svg)
...
![SketchUp Agentic Panorama FloorPlan Plugin agent architecture](docs/agent-architecture.svg)
